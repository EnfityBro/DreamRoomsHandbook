        ...
        subsections: [
            {
                ...
                content: `
                    ...
                    <p>Инциденты - это внезапные аномальные случаи, которые могут появиться только на небезопасных уровнях и несут смертельную угрозу.</p>
                    <p>Предупреждением о начале инцидента является некоторое аномальное поведение на уровне. Каждый инцидент имеет жесткие условия, соблюдая которые, появляется шанс на удачный исход. Неудачным исходом всегда является загадочная смерть.</p>
                `
            },
            {
                id: "sub4-2",
