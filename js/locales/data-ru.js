const guideDataRu = [
        ...
        subsections: [
            ...
            },
            {
                ...
                content: `
                    ...
                    <p>Название: "Офисный лабиринт".<br>Тип: небезопасный.<br>Предметы: пистолет, броня 25%, батарейка, коробка с патронами 9mm x30.<br>Сущности: Улыбающийся, Крадущийся, Карьерист.</p>
            ...
            },
            {
                ...
                content: `
                    ...
                    <p>Название: "Магазин".<br>Тип: небезопасный.<br>Предметы: коробка с патронами 9mm х60, коробка с патронами 12-го калибра х10, фонарик, батарейка.<br>Сущности: Кассир.</p>
    ...
    },
    {
        ...
        subsections: [
            ...
            {
                id: "sub3-4",
                title: "Коробка с патронами 9mm",
                content: `
                    <img src="./img/section3/sub3-4.png" alt="Коробка с патронами 9mm" class="content-image">
            ...
            {
                id: "sub3-13",
                title: "Коробка с патронами 7.62mm",
                content: `
                    <img src="./img/section3/sub3-13.png" alt="Коробка с патронами 7.62mm" class="content-image">
