        ...
        subsections: [
            ...
            },
            {
                ...
                content: `
                    ...
                    <p>The level is a square room with two doors located in opposite corners of the wall. The lighter door leads to a random safe level, the darker one leads to a random unsafe level.</p>
        ...
        subsections: [
            ...
            },
            {
                ...
                content: `
                    ...
                    <p>No more than 1 such pistol can be stored in the inventory. No more than 75 rounds to fire at a time can be prepared.</p>
            ...
            },
            {
                ...
                content: `
                    ...
                    <p>No more than 1 such assault rifle can be stored in the inventory. No more than 150 rounds to fire at a time can be prepared.</p>
                    <p>Caliber: 7.62mm.<br>Magazine capacity: 30 rounds.<br>Fire rate: 850 shots per minute.<br>Reload time: 2.75 seconds.<br>Shooting accuracy: 8.5/10.<br>Recoil: medium.</p>
                `
            },
            {
                id: "sub3-13",
